...
<title>Sitem Informasi Katering Sahabat</title>
...
?>
  ...
  <div id="print">
    ...
    <tr>
      ...
      echo "<div class='title'> Cetak : Tolitoli, $tanggal</div>";

      echo "<h3>LAPORAN PESANAN BULANAN</h3>";

      echo "<h3>Periode bulan ".tgl_indo($bln)."</h3>";
      ...
      echo "<table border='1'>
        ...
        $sql="SELECT * from orders WHERE month(tgl_order)='$_POST[bulan]' AND year(tgl_order)='$_POST[tahun]'";





        $hasil=mysqli_query($koneksi, $sql) or die(mysql_error().$sql);
