                        	...
                        	<div class='navbar'>
                            	<div class='navbar-inner'>
	                                <ul class='breadcrumb'>
	                                    ...
	                                    <li>
	                                        <a href='bagian.php?halamane=home'>Dashboard</a> <span class='divider'>/ Daftar User</span>
	                                    </li>
                          ...
                          <table id="Data-Table" class="table table-bordered table table-striped" cellspacing="0" width="100%">
                            ...
                            <tbody>
                              ...
                              <?php
                                ...
                                $query = mysqli_query($koneksi, "SELECT * FROM admins WHERE level = 'user' ORDER BY uid");
                                $no = 1;
