...
<head>
  ...
  <body onload="setInterval('reloadwaktu()');">
    ...
    if ($data->status_order == "Lunas") {
      ...
      echo "
      <script>
        alert('Order ini telah lunas dan tak dapat diubah!');
        parent.location='order.php';
      </script>
      ";
          ...
          <div class="col-lg-8 col-lg-offset-2">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <form class="" action="order_ubah_proses.php" method="post">

                  <!-- untuk id order -->
                  <input type="hidden" name="id_order" value="<?= $data->id_orders ?>" readonly>
                  ...
                  <div class="form-group">
                      ...
                      <select class="form-control" name="s_order">
                        <option value="<?= $data->status_order ?>"><?= $data->status_order ?></option>
